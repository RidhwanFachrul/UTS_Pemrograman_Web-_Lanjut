                        ...
                        @foreach ($post_archive as $postArchive)
                            <div class="col-lg-6">
                                <div class="card border-0 bg-light rounded-4">
                                    @if ($postArchive->featured_image && Storage::exists('public/storage/images/posts/1.jpg' . $postArchive->featured_image))
                                        <img src="{{ asset('storage/images/posts/' . $postArchive->featured_image) }}"
                                            class="card-img-top">
                                    @else
                                        <img src="{{ asset('storage/images/posts/1.jpg') }}" class="card-img-top">
                                    @endif
                                    <div class="card-body">
                                        <h5 class="card-title">
